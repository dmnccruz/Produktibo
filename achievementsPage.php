...
<head>
    ...
    <title>Produktibo | Achievements Page</title>
...
<div class=chartsWrapper>
 ...
 $tasks_query2 = "SELECT * FROM tasks WHERE user_id = $user_id && status_id = 1";
 ...
 ?><p style="display: none;" id="finishedTask"><?php echo mysqli_num_rows($tasks)?></p><?php
        
        ?>
        <p style="display: none;" id="unFinishedTask"><?php echo mysqli_num_rows($tasks2) ?></p>
...
<iframe id="calendarIframe" src="calendarPage.php" width="100%" height="100%">
            ...
            <div class="contentWrapper">
                <div class="picMottoContainer">
                    ...
                    <div class="motto">
                        ...
                        <h1 class="mottoWords" id="achievementsWords"></h1>
                ...
                <div class="menuBar">
                    ...
                    <div class="achievementsMenu"><a href="#" id="achievementsLink">Achievements</a></div>
    ...
    <script>
        ...
        var g=0,text;
        var achievementsWords = "    " + "Achievements!"

        function typing2() {
        if(g<achievementsWords.length){
            document.getElementById("achievementsWords").innerHTML += achievementsWords.charAt(g);
            g++;
