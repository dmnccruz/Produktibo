...
<head> 
    ...
    <script src="https://cdnjs.com/libraries/Chart.js" defer></script>
    <script src="assets/js/main.js" defer></script>
    <script src="assets/js/motivations.js" defer></script>

    <title>Produktibo | Motivations Page</title>

</head>
<body>

<div class=noteFormWrapper id="noteFormWrapper">
    <form action="" method="POST" id="sendNoteForm">

        <label for="uniqueID">User's unique ID</label><br>
            <input name="uniqueID" id="uniqueID" class="noteForms" type="text" placeholder=""><br><br>
        <label for="message">Write your message!</label><br>
            <input name="message" id="message" class="noteForms" type="text" placeholder=""><br><br>
        <label for="selectColor">Pick a color</label><br>
            <select id="selectColor" class="noteForms" name="colors" id="" placeholder="Pick a color!">
                <option value="lightBlue">Light Blue</option>
                <option value="lemon">Lemon</option>
                <option value="lightGreen">Light Green</option>
                <option value="pink">Pink</option>
            </select><br><br>
        <div  class="sendNoteButtons">
            <button name="sendNoteButton" id="sendNoteButton" type="button">SEND</button><br>
            <button name="cancelNoteButton" id="cancelNoteButton" type="button">CANCEL</button><br>
        </div>
    </form>    
</div>

<div class=motivationsWrapper>
    <div class=motivationsFiller></div>

        <div class=motivations>

            <div class="sendNote">
                <button type="button" id="sendMotiv">Send a motivation!</button>
            </div>
                    <?php
    
                    $user_id =  $_SESSION['user']['id'];
                    $notes_query = "SELECT * FROM motivations WHERE user_id = $user_id";
                    ...
                    ?>
                <div id="scaler">
            <div style="background: <?php echo $indivNote['color']?>; transform: rotate(-<?php echo $indivNote['rotate']?>deg)" class="motivationalNote">
                <h3><?php echo $indivNote['message']; ?></h3><br><br>
                <p><?php echo "--".$sender['nickName']?></p>

                <a href="controllers/process_desk_note.php?note_id=<?php echo $indivNote['id'];?>" class="noteButton" id="noteButton">DESK</a>
                </div>
            </div>
            <?php
                }
...
<iframe id="calendarIframe" src="calendarPage.php" width="100%" height="100%">
    ...
    <div id="markerDrag" class="markerSVG" style="display:none;"></div>
    <div id="phoneDrag" class="phoneSVG drag" style="display:none;"></div>
    <div id="eraserDrag" class="eraserSVG drag" style="display:none;"></div>
    <div id="pencilDrag" class="pencilSVG drag" style="display:none;"></div>
            ...
            <div class="contentWrapper">
                <div class="picMottoContainer">
                    <div class="pPicture">
                        ...
                        <!-- <div class="profilePicWrap2" id="profilePicWrap"></div> -->
                    </div>
                    <div class="motto">
                        <p id="mottohide" style="display:none"><?php echo $_SESSION['user']['motto']?></p>
                        <h1 class="mottoWords" id="motivationalWords"></h1>
                        <h1 class="mottoWords" id="mottoWords" style="display:none;"></h1>
                ...
                <div class="menuBar">
                    ...
                    <div class="profileMenu"><a id="profileLink">Profile</a></div>
                    <div class="calendarMenu"><a id="calendarLink">Calendar</a></div>
                    <div class="motivationsMenu"><a href="#" id="motivationsLink">Motivations</a></div>
                ...
                <div class="navTasks">
                    <div class="dateToday" id="dateToday" style="display:none"></div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        var g=0,text;
        var motivationalWords = "    " + "Motivations!"

        function typing2() {
        if(g<motivationalWords.length){
            document.getElementById("motivationalWords").innerHTML += motivationalWords.charAt(g);
            g++;
            setTimeout(typing2,250);
            }
        }
        typing2();
